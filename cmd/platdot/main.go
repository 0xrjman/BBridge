...
func sendSimpleTx() bool {
	nnnPk := types.MustHexDecodeString("0x923eeef27b93315c97e63e0c1284b7433ffbc413a58da0626a63955a48586075")

	api, err := gsrpc.NewSubstrateAPI("wss://xbridge.spiderx.pro/ws")
	if err != nil {
		panic(err)
	}
